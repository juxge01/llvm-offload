...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @batched_gemm_accel(ptr noundef %0, ptr noundef %1, ptr noundef %2) #2 {
  %4 = alloca ptr, align 4
  %5 = alloca ptr, align 4
  %6 = alloca ptr, align 4
  %7 = alloca i32, align 4
  ...
  call void @dma_wait()
  call void asm sideeffect ".insn r 0x7b, 0, 0, x0, $0, $1", "r,r,~{memory}"(i32 1073741824, i32 1074003968) #7, !srcloc !11
...
declare dso_local void @dma_kick(i32 noundef, i32 noundef, i32 noundef, i32 noundef) #3

declare dso_local void @dma_wait() #3
...
20:                                               ; preds = %17
  ...
  call void @__divdc3(ptr sret({ double, double }) align 8 %7, double noundef -0.000000e+00, double noundef 0xC00921FB54442D18, double noundef %24, double noundef 0.000000e+00) #7
  ...
  call void @cexp(ptr sret({ double, double }) align 8 %8, ptr noundef %9) #7
...
49:                                               ; preds = %45
  ...
  br i1 %69, label %70, label %78, !prof !17

70:                                               ; preds = %49
  %71 = fcmp uno float %68, %68
  br i1 %71, label %72, label %78, !prof !17

72:                                               ; preds = %70
  %73 = call [2 x i32] @__mulsc3(float noundef %51, float noundef %53, float noundef %60, float noundef %62) #7
...
78:                                               ; preds = %72, %70, %49
  ...
  br i1 %140, label %141, label %149, !prof !17

141:                                              ; preds = %78
  %142 = fcmp uno float %139, %139
  br i1 %142, label %143, label %149, !prof !17

143:                                              ; preds = %141
  %144 = call [2 x i32] @__mulsc3(float noundef %131, float noundef %133, float noundef %127, float noundef %129) #7
...
18:                                               ; preds = %14
  ...
  %33 = call float @tanhf(float noundef %32) #7
...
52:                                               ; preds = %14
  ...
  %67 = call double @sqrt(double noundef %66) #7
...
110:                                              ; preds = %94
  ...
  %124 = call noalias ptr @malloc(i32 noundef 16384) #8
...
138:                                              ; preds = %125
  ...
  %145 = call noalias ptr @malloc(i32 noundef 16384) #8
...
declare dso_local noalias ptr @malloc(i32 noundef) #5

declare dso_local void @free(ptr noundef) #3

; Function Attrs: nounwind memory(none)
declare i32 @llvm.riscv.custom3(i32, i32) #6
...
attributes #2 = { noinline nounwind optnone uwtable "frame-pointer"="all" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic-rv32" "target-features"="+32bit,+a,+c,+m,+relax,-d,-e,-experimental-smaia,-experimental-ssaia,-experimental-zacas,-experimental-zfa,-experimental-zfbfmin,-experimental-zicond,-experimental-zihintntl,-experimental-ztso,-experimental-zvbb,-experimental-zvbc,-experimental-zvfbfmin,-experimental-zvfbfwma,-experimental-zvkg,-experimental-zvkn,-experimental-zvknc,-experimental-zvkned,-experimental-zvkng,-experimental-zvknha,-experimental-zvknhb,-experimental-zvks,-experimental-zvksc,-experimental-zvksed,-experimental-zvksg,-experimental-zvksh,-experimental-zvkt,-f,-h,-save-restore,-svinval,-svnapot,-svpbmt,-v,-xcvbitmanip,-xcvmac,-xsfcie,-xsfvcp,-xtheadba,-xtheadbb,-xtheadbs,-xtheadcmo,-xtheadcondmov,-xtheadfmemidx,-xtheadmac,-xtheadmemidx,-xtheadmempair,-xtheadsync,-xtheadvdot,-xventanacondops,-zawrs,-zba,-zbb,-zbc,-zbkb,-zbkc,-zbkx,-zbs,-zca,-zcb,-zcd,-zce,-zcf,-zcmp,-zcmt,-zdinx,-zfh,-zfhmin,-zfinx,-zhinx,-zhinxmin,-zicbom,-zicbop,-zicboz,-zicntr,-zicsr,-zifencei,-zihintpause,-zihpm,-zk,-zkn,-zknd,-zkne,-zknh,-zkr,-zks,-zksed,-zksh,-zkt,-zmmul,-zve32f,-zve32x,-zve64d,-zve64f,-zve64x,-zvfh,-zvl1024b,-zvl128b,-zvl16384b,-zvl2048b,-zvl256b,-zvl32768b,-zvl32b,-zvl4096b,-zvl512b,-zvl64b,-zvl65536b,-zvl8192b" }
...
attributes #5 = { allocsize(0) "frame-pointer"="all" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic-rv32" "target-features"="+32bit,+a,+c,+m,+relax,-d,-e,-experimental-smaia,-experimental-ssaia,-experimental-zacas,-experimental-zfa,-experimental-zfbfmin,-experimental-zicond,-experimental-zihintntl,-experimental-ztso,-experimental-zvbb,-experimental-zvbc,-experimental-zvfbfmin,-experimental-zvfbfwma,-experimental-zvkg,-experimental-zvkn,-experimental-zvknc,-experimental-zvkned,-experimental-zvkng,-experimental-zvknha,-experimental-zvknhb,-experimental-zvks,-experimental-zvksc,-experimental-zvksed,-experimental-zvksg,-experimental-zvksh,-experimental-zvkt,-f,-h,-save-restore,-svinval,-svnapot,-svpbmt,-v,-xcvbitmanip,-xcvmac,-xsfcie,-xsfvcp,-xtheadba,-xtheadbb,-xtheadbs,-xtheadcmo,-xtheadcondmov,-xtheadfmemidx,-xtheadmac,-xtheadmemidx,-xtheadmempair,-xtheadsync,-xtheadvdot,-xventanacondops,-zawrs,-zba,-zbb,-zbc,-zbkb,-zbkc,-zbkx,-zbs,-zca,-zcb,-zcd,-zce,-zcf,-zcmp,-zcmt,-zdinx,-zfh,-zfhmin,-zfinx,-zhinx,-zhinxmin,-zicbom,-zicbop,-zicboz,-zicntr,-zicsr,-zifencei,-zihintpause,-zihpm,-zk,-zkn,-zknd,-zkne,-zknh,-zkr,-zks,-zksed,-zksh,-zkt,-zmmul,-zve32f,-zve32x,-zve64d,-zve64f,-zve64x,-zvfh,-zvl1024b,-zvl128b,-zvl16384b,-zvl2048b,-zvl256b,-zvl32768b,-zvl32b,-zvl4096b,-zvl512b,-zvl64b,-zvl65536b,-zvl8192b" }
